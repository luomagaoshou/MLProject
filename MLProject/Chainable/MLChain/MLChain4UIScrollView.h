...
#define scrollToTopAnimated(...) scrollToTopAnimated(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
- (MLChainParamBlock4UIScrollView)scrollToTopAnimated;

#ifndef scrollToBottomAnimated
#define scrollToBottomAnimated(...) scrollToBottomAnimated(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
- (MLChainParamBlock4UIScrollView)scrollToBottomAnimated;

#ifndef scrollToLeftAnimated
#define scrollToLeftAnimated(...) scrollToLeftAnimated(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
- (MLChainParamBlock4UIScrollView)scrollToLeftAnimated;

#ifndef scrollToRightAnimated
#define scrollToRightAnimated(...) scrollToRightAnimated(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
...
#define shouldRestoreScrollViewContentOff(...) shouldRestoreScrollViewContentOff(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
...
#define ab_scrollToSelectionOfTextView_animated(...) ab_scrollToSelectionOfTextView_animated(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)), ml_chain_MASBoxValue(metamacro_at(1, __VA_ARGS__)))
#endif
...
#define ab_adjustForAutomaticKeyboardInfo_lastAdjustment(...) ab_adjustForAutomaticKeyboardInfo_lastAdjustment(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)), ml_chain_MASBoxValue(metamacro_at(1, __VA_ARGS__)))
#endif
