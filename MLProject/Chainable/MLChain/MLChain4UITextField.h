...
#ifndef leftViewOff
#define leftViewOff(...) leftViewOff(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
#ifndef leftViewOff_
#define leftViewOff_(...)  leftViewOff(ml_chain_MASBoxValue(CGPointMake(__VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)leftViewOff;

#ifndef leftViewSizeProportion
#define leftViewSizeProportion(...) leftViewSizeProportion(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)leftViewSizeProportion;

#ifndef rightViewOff
#define rightViewOff(...) rightViewOff(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
#ifndef rightViewOff_
#define rightViewOff_(...)  rightViewOff(ml_chain_MASBoxValue(CGPointMake(__VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)rightViewOff;

#ifndef editRectOff
#define editRectOff(...) editRectOff(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
#ifndef editRectOff_
#define editRectOff_(...)  editRectOff(ml_chain_MASBoxValue(CGPointMake(__VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)editRectOff;

#ifndef textLabelOff
#define textLabelOff(...) textLabelOff(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
#ifndef textLabelOff_
#define textLabelOff_(...)  textLabelOff(ml_chain_MASBoxValue(CGPointMake(__VA_ARGS__)))
#endif
...
#endif
#ifndef leftViewRect_
#define leftViewRect_(...)  leftViewRect(ml_chain_MASBoxValue(CGRectMake(__VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)leftViewRect;

#ifndef rightViewRect
#define rightViewRect(...) rightViewRect(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
#ifndef rightViewRect_
#define rightViewRect_(...)  rightViewRect(ml_chain_MASBoxValue(CGRectMake(__VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)rightViewRect;

#ifndef rightViewSizeProportion
#define rightViewSizeProportion(...) rightViewSizeProportion(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
- (MLChainParamBlock4UITextField)rightViewSizeProportion;

#ifndef textFieldCommonType
#define textFieldCommonType(...) textFieldCommonType(ml_chain_MASBoxValue(metamacro_at(0, __VA_ARGS__)))
#endif
