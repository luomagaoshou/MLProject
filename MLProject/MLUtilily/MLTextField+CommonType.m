...
- (void)setTextFieldCommonOption:(UITextFieldCommonOption)textFieldCommonOption
{
    ...
    if (self.textFieldCommonOption & UITextFieldCommonOptionLeftImageView){
        ...
        self.placeHolderLabelOffset = CGPointMake(10, 0);
        ...
        UIImageView *imagaView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 15, self.height - 30, self.height - 30)];
             imagaView.contentMode = UIViewContentModeScaleAspectFit;
    
        self.leftView = imagaView;
        
    }
    if (self.textFieldCommonOption & UITextFieldCommonOptionRightImageView){
    ...
    if (self.textFieldCommonOption & UITextFieldCommonOptionLeftButton){
        
         self.leftViewMode = UITextFieldViewModeAlways;
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom frame:CGRectMake(0, 5, self.height - 10, self.height - 10) title:@""];
        self.leftView = button;
        
    }
    if (self.textFieldCommonOption & UITextFieldCommonOptionRightButton){
    ...
    if (self.textFieldCommonOption & UITextFieldCommonOptionLeftLabel){
